...
namespace RateTheRoast
{
    public class WishlistsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Wishlist.Include(w => w.Coffee).Include(w => w.User);
        ...
        public async Task<IActionResult> Create([Bind("WishlistId,UserId,CoffeeId")] Wishlist wishlist)
        {
